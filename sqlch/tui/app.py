...
from textual.widgets import Header, Footer, Input, ListView, ListItem, Label, SelectionList
...
class SQLCH(App):
    TITLE = 'SQLCH'
    CSS = '\n    Screen {\n        background: black;\n    }\n    #sidebar {\n        width: 30%;\n        border: round white;\n        padding: 1 1;\n    }\n    #main {\n        width: 70%;\n        border: round white;\n        padding: 1 1;\n    }\n    #status {\n        margin-top: 1;\n        height: 3;\n        border: round white;\n        padding: 0 1;\n    }\n    '
    BINDINGS = [Binding('q', 'quit', 'Quit'), Binding('p', 'preview', 'Preview'), Binding('enter', 'play', 'Play'), Binding('a', 'add', 'Add Selected'), Binding('s', 'stop', 'Stop'), Binding('r', 'refresh_library', 'Refresh Library')]
    ...
    def action_play(self):
        self._with_selected_station(lambda url, st: player.play_url(url, name=st.get('name')), 'Playing')
